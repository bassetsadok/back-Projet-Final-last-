...
class ApiFeatures {
  ...
  search() {
    if (this.queryString.q) {
      const re = new RegExp(this.queryString.q, 'gi');

      this.mongoQuery = this.mongoQuery.find({ name: { $regex: re } });
    }
